...
DIFFICULTIES = {
    "easy":       dict(heat_search_area=0.10, heat_spread=1.5, tile_timeout_curr=10.0, tile_timeout_minimum=5.0,
                       tile_timeout_decay=0.3, round_timer_curr=15.0, round_timer_minimum=8.0, round_timer_decay=0.5),
    "medium":     dict(heat_search_area=0.25, heat_spread=1.0, tile_timeout_curr=8.0,  tile_timeout_minimum=3.5,
                       tile_timeout_decay=0.4, round_timer_curr=13.0, round_timer_minimum=6.0, round_timer_decay=0.5),
    "hard":       dict(heat_search_area=0.45, heat_spread=0.6, tile_timeout_curr=6.0,  tile_timeout_minimum=2.5,
                       tile_timeout_decay=0.5, round_timer_curr=11.0, round_timer_minimum=5.0, round_timer_decay=0.6),
    "nightmare":  dict(heat_search_area=0.65, heat_spread=0.3, tile_timeout_curr=5.0,  tile_timeout_minimum=2.0,
                       tile_timeout_decay=0.5, round_timer_curr=9.0,  round_timer_minimum=4.0, round_timer_decay=0.7),
}
