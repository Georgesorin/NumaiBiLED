...
DIFFICULTIES = {
    "easy":       dict(heat_search_area=0.30, heat_spread=1.5, tile_timeout_curr=6.2, tile_timeout_minimum=3.8,
                       tile_timeout_decay=0.2, round_timer_curr=10.0, round_timer_minimum=7.0, round_timer_decay=0.5),
    "medium":     dict(heat_search_area=0.50, heat_spread=1.0, tile_timeout_curr=5.7,  tile_timeout_minimum=3.0,
                       tile_timeout_decay=0.35, round_timer_curr=9.0, round_timer_minimum=6.0, round_timer_decay=0.5),
    "hard":       dict(heat_search_area=0.75, heat_spread=0.6, tile_timeout_curr=5.0,  tile_timeout_minimum=2.7,
                       tile_timeout_decay=0.4, round_timer_curr=8.0, round_timer_minimum=5.0, round_timer_decay=0.5),
    "nightmare":  dict(heat_search_area=0.90, heat_spread=0.3, tile_timeout_curr=4.8,  tile_timeout_minimum=2.3,
